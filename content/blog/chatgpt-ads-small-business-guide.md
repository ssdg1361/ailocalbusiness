---
title: "How to Advertise on ChatGPT in 2026: Real Costs and What You Need to Know"
date: 2026-06-16
description: "A hands-on 2026 walkthrough of ChatGPT Ads Manager for small businesses: the real minimum budget, what clicks actually cost, the EIN verification gate, and whether it's worth it."
summary: "ChatGPT now sells ads — and most guides are vague on what it actually costs and what it takes to get in. Here's a hands-on walkthrough from inside the Ads Manager, including the EIN gate nobody warns you about."
tags: ["chatgpt", "chatgpt-ads", "ppc", "ai-search", "small-business"]
...
TocOpen: true
faq:
  - question: "Is there a minimum budget to advertise on ChatGPT?"
    answer: "No. As of 2026, ChatGPT's self-serve Ads Manager has no minimum spend — you can set a campaign total budget as low as $1. That's enough to create a campaign and learn the platform, but not enough to win meaningful clicks, since cost-per-click bids start around $3."
  - question: "Do you need an EIN to run ChatGPT ads?"
    answer: "Yes. ChatGPT Ads Manager requires a verified US business entity with an EIN (tax ID) plus a government-issued ID before your ads can run. This is a real hurdle for sole proprietors and brand-new businesses. The legitimate fix is simple: a sole proprietor can get an EIN free from the IRS online in a few minutes."
  - question: "How much do ChatGPT ads cost per click?"
    answer: "The recommended starting cost-per-click bid is roughly $3 to $5 as of mid-2026. In the Ads Manager, a $2 bid is flagged as 'may not deliver' while $3 shows 'strong delivery.' Industry matters: e-commerce and retail run near $3 to $5, while software and finance can run higher."
  - question: "Do ChatGPT ads change the AI's actual answer?"
    answer: "No. Ads appear as clearly labeled 'Sponsored' results below the answer for logged-in free users; paid ChatGPT tiers stay ad-free. The conversational answer itself is organic and can't be bought — you still earn that through the quality of your online presence."
  - question: "Can agencies run ChatGPT ads on behalf of clients?"
    answer: "Not cleanly yet. During the Beta, the Ads Manager is oriented around advertising for your own business, and creating advertiser accounts on behalf of clients isn't well supported. Agencies should expect friction here until OpenAI adds proper multi-client management."
  - question: "Is it legal to advertise on ChatGPT?"
    answer: "Yes. ChatGPT ads are a standard self-serve advertising product, subject to the same advertising and consumer-protection rules as any other platform, plus OpenAI's own ad policies. The verification step — a registered US business, an EIN, and a government ID — is part of how OpenAI enforces that. There's nothing legally unusual about running them; the friction is procedural, not legal."
  - question: "Can you still buy ads on ChatGPT, or did OpenAI get rid of them?"
    answer: "You can buy them. ChatGPT ads are live in 2026 through OpenAI's self-serve Ads Manager (Beta) — they were added, not removed. What keeps changing is the detail: pricing, access, and which businesses qualify have all shifted across the year, so verify the current state before you budget."
  - question: "How do ChatGPT ads compare to Google Search ads?"
    answer: "ChatGPT ads are cheaper to start but harder to qualify for and far less mature. Google offers volume, precise targeting, and proven tracking today; ChatGPT offers an early, low-competition placement that isn't yet a reliable lead engine. For most local businesses, Google is the workhorse and ChatGPT is a small, optional experiment."
---
...
![The ChatGPT Ads Manager (Beta) interface](/images/chatgpt-ads/04-ad-manager.jpeg "ChatGPT's Ads Manager, currently in Beta")
...
![Setting a $1 campaign total budget in ChatGPT Ads Manager](/images/chatgpt-ads/01-budget.jpeg "You can set a campaign total budget as low as $1")
...
![ChatGPT Ads delivery meter: a low bid shows "may not deliver," a higher bid shows "Strong Delivery"](/images/chatgpt-ads/02-cpc-meter.jpeg "At $2 the bid may not deliver; at $3+ it shows strong delivery")
...
![The ChatGPT ad creative builder with headline, description, and image fields](/images/chatgpt-ads/03-ad-creative.jpeg "The ad creative step: headline (50 char), description (100 char), and a square image")
...
|---|---|---|
| **Minimum to start** | $0 — a $1 campaign budget is accepted | No hard minimum, but needs real budget to learn |
| **Effective cost per click** | ~$3–$5 to deliver reliably | Varies widely, often $1–$10+ by industry |
| **Approval to run** | Verified US business + EIN + ID (3–7 days) | Open to almost anyone, near-instant |
| **Targeting** | Early "context hints," still maturing | Mature keyword, location, and audience targeting |
| **Reporting** | Basic, pixel-based conversion tracking | Deep, well-documented tracking |
| **Who sees it** | Logged-in free ChatGPT users | Anyone searching Google |
| **Why bother now** | Early, low competition, cheap entry | Volume and reliability today |
...
*Want to know whether ChatGPT recommends your business before you spend a dime on ads? I run a [free AI search audit](/audit/) for Bergen County and North Jersey businesses — or call/text **[(201) 903-3491](tel:+12019033491)**.*
